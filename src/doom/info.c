...
const char *sprnames[] = {
	...
	"VSRM","ARSD","REGN","TNT1", "REGN", "SP00","SP01","SP02", "SP03", 
...
void A_NoiseAlert();
void A_JumpIfSkill();
void A_MonsterProjectile2();
void A_MonsterMeleeAttack();
void A_MonsterBulletAttack2();
void A_Thrust();
void A_ThrustZ();
void A_AddFlags();
void A_RemoveFlags();
...
state_t	states[NUMSTATES] = {
    ...
    {SPR_REGN, 32771, 6, {NULL}, S_REGENERATION, 0, 0}
}; 
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
	...
	MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,		// flags
	S_NULL,		// raisestate
	MF2_FULLVOLSOUNDS|MF2_NORADIUSDMG			//flags2
    },
